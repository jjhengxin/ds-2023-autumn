    ...
    for link in soup.find_all('a'):
        ...
        if href:  # 确保链接存在
            ...
            if href.startswith('/web/book'):
                ...
                comment_number = dselector.xpath("//*[@id='routerView']/div[1]/div[3]/div[2]/div[1]/div/span/text()")
                grade = dselector.xpath("//*[@id='routerView']/div[1]/div[3]/div[1]/span/text()")
                print(comment_number,grade)
